...
export const Testimonials = () => {
  ...
  return (
    <div className="w-full p-[1rem]" id='testimonials'>
      <div ref={titleElem} className="relativ w-fit mx-auto my-[1rem] my-[2rem] lg:mb-[4rem]">
      ...
      <div className="flex flex-col xl:w-[80%] mx-auto">
        ...
        <div className='flex flex-col lg:flex-row gap-[1rem] my-[2rem] lg:w-[90%] lg:w-[80%] mx-auto'>
