...
export const ServiceCard = ({serviceInfo}) => {
  ...
  return (
    <div ref={targetElem} className="w-[300px] h-[550px] bg-white border border-gray-200 rounded-lg shadow mx-auto">
      ...
      <div className="p-5 mx-0">
        ...
        <p className="mb-3 font-normal text-lg text-gray-900 text-left">
